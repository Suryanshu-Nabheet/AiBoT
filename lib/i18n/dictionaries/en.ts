...
export const en = {
  ...
  "general.language.desc": "The language used for the interface and AI replies.",
  "general.notifications.title": "Desktop Notifications",
  "general.notifications.desc": "Get alerted when AI finishes long reasoning tasks.",
  "general.notifications.enabled": "Desktop notifications enabled",
  "general.notifications.denied": "Notification permission was denied in your browser",
  "general.notifications.unsupported": "Desktop notifications are not supported in this browser",
  ...
  "general.sound.desc": "Play a short chime when a long response finishes (tab must be audible).",
  ...
  "models.unlock.desc": "Add your API keys in the API Keys section to automatically reveal models from OpenAI, Anthropic, and more.",
  "models.unlock.link": "API Keys",

  // API Keys
  "apiKeys.title": "API Keys & Secrets",
  "apiKeys.subtitle": "Use your own keys to access specialized models or increase limits.",
  ...
  "apiKeys.storage.desc": "Your API keys stay on this device in local storage. They are sent only to the matching provider when you chat — never to AiBoT servers for storage.",

  // Local LLM
  "localLlm.title": "Local LLM (Ollama)",
  "localLlm.subtitle": "Access open-weights model families directly on your own local device.",
  "localLlm.endpoint": "Ollama Server Endpoint",
  "localLlm.hint": "Ensure Ollama is running on your machine. On macOS/Windows, make sure the Ollama application is active in the menu bar.",
  ...
  "localLlm.empty.desc": "Make sure Ollama is active on your device. Click Auto Detect to scan your local setup and immediately populate available local models.",
  "localLlm.privacy.title": "100% Privacy & Zero Limits",
  "localLlm.privacy.desc": "Local execution is handled direct-to-device. Your prompts and code sessions never leave your local machine, and you enjoy zero API usage fees or latency thresholds.",
  "localLlm.status.connected": "Connected",
  "localLlm.status.disconnected": "Not connected",
  "localLlm.status.unknown": "Not scanned yet",
  "localLlm.scan.success": "Success! Detected and auto-enabled {count} local Ollama models.",
  "localLlm.scan.empty": "Connected to Ollama, but no models were found. Try pulling a model first (e.g. `ollama run llama3`).",
  "localLlm.scan.loopback": "Success! Connected to local Ollama via 127.0.0.1 loopback.",
  "localLlm.scan.fail": "Could not connect to Ollama. Production secure connections require CORS setup. Read troubleshooting steps below.",
  "localLlm.diagnostics.title": "Local Connection Diagnostics",
  "localLlm.diagnostics.desc": "Deployed secure websites (HTTPS) are blocked from accessing local API endpoints (http://localhost:11434) unless Cross-Origin Resource Sharing (CORS) is explicitly enabled on your machine.",
  ...
  "about.developer.bio": "A visionary software architect and AI engineer focused on pushing the boundaries of autonomous coding and high-performance intelligent systems.",
  ...
  "about.feature.orchestration.desc": "State-of-the-art routing engine that dynamically switches between frontier LLMs based on task complexity and performance metrics.",
  "about.feature.coding.title": "Autonomous Coding Environment",
  "about.feature.coding.desc": "Real-time web prototyping and functional application generation from natural language, powered by specialized reasoning models and a custom execution context.",
  "about.feature.research.title": "Research-Grade Document Intelligence",
  "about.feature.research.desc": "Deep synthesis and multi-format data extraction capable of processing massive datasets for comprehensive, cross-referenced research insights.",
  ...
  "toast.speech.unsupported": "Speech recognition is not supported in this browser.",
  ...
  "toast.file.extractFail": "Could not extract text from {name}. Try the Summarizer feature.",
  "toast.clipboard": "Copied to clipboard",

  // Errors
  "errors.connectionInterrupted": "**Connection Error:** The stream was interrupted. Please try again.",
  "errors.network": "**Network Error**: {message}",
  "errors.http": "**Error {status}**: {detail}",
  "errors.noApiKey": "No API key available. Add a provider key in Settings or configure OPENROUTER_API_KEY.",
  ...
  "agent.summarizer.subtitle": "Upload documents for research-grade synthesis and insights.",
  ...
  "agent.coder.placeholder": "Describe the app or component you want to build...",
  ...
  "agent.coder.disclaimer": "Generated code runs in your browser preview. Review before shipping.",
