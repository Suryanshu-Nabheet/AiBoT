...
function CommandDialog({
  ...
  /** Keyboard palettes should open instantly (no zoom/fade). */
  instant = true,
  ...props
...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        "relative flex cursor-default items-center gap-2 rounded-md px-2 py-2.5 text-sm outline-hidden select-none",
