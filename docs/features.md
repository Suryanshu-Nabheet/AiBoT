...
## Document Intelligence (Summarizer Agent)

The Summarizer Agent converts static documents into actionable insights.

### Capabilities
- **Multi-Format Extraction**: Supports PDF, DOCX, TXT, MD, and JSON.
- **Batch Processing**: Upload and analyze multiple documents simultaneously.
- **Research-Grade Analysis**: Configured to provide comprehensive, detailed responses (typically 1000+ words).
- **Text-to-Speech**: Integrated audio feedback for reading summaries.
- **PDF Export**: Generate professional PDF reports from AI-synthesized content.
